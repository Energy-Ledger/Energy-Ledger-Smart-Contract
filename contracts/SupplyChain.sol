...
contract SupplyChain is Ownable
{
    ...
    constructor(address _tokenAddress) {
        admin = msg.sender;
        setUser(msg.sender, 'William Pete', 'william@energyledger.com', 'eyJjb21wYW55TmFtZSI6IkVuZXJneSBMZWRnZXIiLCJjb250YWN0QWRkcmVzcyI6IlVTQSJ9', '9999999999', 'admin', true, true, '11');
